...
@Component
public class ContractResultResponseToTransactionConverter implements Converter<ContractResultResponse, Web3jTransaction> {

    @Override
    public Web3jTransaction convert(MappingContext<ContractResultResponse, Web3jTransaction> mappingContext) {
...
//        tx.setNonce(res.getNonce().toString());
        ...
        tx.setTransactionIndex(res.getTransactionIndex() != null ? res.getTransactionIndex().toString() : null);
