...
public class EthBlockToWeb3jBlockConverter implements Converter<EthBlock.Block, Web3jBlock> {
    ...
    public Web3jBlock convert(final MappingContext<EthBlock.Block, Web3jBlock> mappingContext) {
        ...
        destination.setNonce(source.getNonceRaw() == null || NONCE_ZERO.equals(source.getNonceRaw()) ? null : source.getNonce());
        ...
        destination.setTotalDifficulty(source.getTotalDifficultyRaw() != null ? source.getTotalDifficulty() : null);
