...
public class PollingBlockchainSubscriptionStrategyTest {
    ...
    public void init() {
        ...
        when(mockHederaService.blocksFlowable(BLOCK_NUMBER, POLLING_INTERVAL)).thenReturn(hederaBlockPublishProcessor);
        ...
        underTest = new PollingBlockSubscriptionStrategy(mockWeb3j,
                NODE_NAME, NodeType.NORMAL.name(), new DummyAsyncTaskService(), mockBlockNumberService, mockHederaService, POLLING_INTERVAL);
    ...
    public void testHederaSubscribe() {
        underTest = new PollingBlockSubscriptionStrategy(mockWeb3j,
                NODE_NAME, NodeType.MIRROR.name(), new DummyAsyncTaskService(), mockBlockNumberService, mockHederaService, POLLING_INTERVAL);
