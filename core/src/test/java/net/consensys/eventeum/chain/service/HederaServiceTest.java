...
class HederaServiceTest {
    ...
    public void getEventForFilter() {
        ...
        ParameterDefinition indexedParameter = new ParameterDefinition(0, ParameterType.build("STRING"));
        eventSpecification.setIndexedParameterDefinitions(Collections.singletonList(indexedParameter));
        ParameterDefinition nonIndexedParameter = new ParameterDefinition(0, ParameterType.build("STRING"));
        eventSpecification.setNonIndexedParameterDefinitions(Collections.singletonList(nonIndexedParameter));
        ...
        when(contractEventDetailsFactory
                .createEventDetails(
                        eq(eventFilter), any(),
        ...
        ContractEventDetails event = hederaService.getEventForFilter(eventFilter, mockLogResponse, mockContractResult);
